...
const mockDestinations: Destination[] = [
  {
    ...
    category: 'City',
    region: 'Europe',
    image_urls: ['https://images.unsplash.com/photo-1550340499-a6c60fc8287c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80'],
  ...
  },
  {
    ...
    category: 'City',
    region: 'Asia',
    image_urls: ['https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80'],
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    category: 'Beach',
    region: 'Europe',
    image_urls: ['https://images.unsplash.com/photo-1613395877344-13d4a8e0d49e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80'],
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    notes: 'The city that never sleeps! Times Square, Central Park, and Broadway shows.',
    visited: false,
    category: 'City',
    region: 'North America',
    image_urls: ['https://images.unsplash.com/photo-1496442226666-8b4d3d9999b6?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80'],
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    name: 'Bali',
    country: 'Indonesia',
    notes: 'Tropical paradise with beautiful beaches, temples, and rice terraces.',
    visited: true,
    category: 'Beach',
    region: 'Asia',
    image_urls: ['https://images.unsplash.com/photo-1537953773345-d172ccf13cf1?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80'],
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    notes: 'Historic city with Big Ben, Tower Bridge, and world-class museums.',
    visited: false,
    category: 'City',
    region: 'Europe',
    image_urls: ['https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80'],
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    name: 'Rome',
    country: 'Italy',
    notes: 'The Eternal City! Colosseum, Vatican, and amazing Italian cuisine.',
    visited: true,
    category: 'Culture',
    region: 'Europe',
    image_urls: ['https://images.unsplash.com/photo-1552832230-c0197dd311b5?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80'],
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    name: 'Sydney',
    country: 'Australia',
    notes: 'Harbor city with the iconic Opera House and Harbour Bridge.',
    visited: false,
    category: 'City',
    region: 'Oceania',
    image_urls: ['https://images.unsplash.com/photo-1506905925346-14b1e0d0fb0d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80'],
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    notes: 'Modern metropolis with the Burj Khalifa and luxury shopping.',
    visited: false,
    category: 'City',
    region: 'Asia',
    image_urls: ['https://images.unsplash.com/photo-1512453979798-5ea266f8880c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80'],
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    name: 'Barcelona',
    country: 'Spain',
    notes: 'Gaudi architecture, beautiful beaches, and vibrant culture.',
    visited: true,
    category: 'Culture',
    region: 'Europe',
    image_urls: ['https://images.unsplash.com/photo-1539037116277-4db20889f2d4?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80'],
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    name: 'Maldives',
    country: 'Maldives',
    notes: 'Overwater bungalows, crystal clear waters, and perfect beaches.',
    visited: false,
    category: 'Beach',
    region: 'Asia',
    image_urls: ['https://images.unsplash.com/photo-1506905925346-14b1e0d0fb0d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80'],
  ...
  },
  {
    ...
    name: 'Machu Picchu',
    country: 'Peru',
    notes: 'Ancient Incan citadel high in the Andes mountains.',
    visited: false,
    category: 'Adventure',
    region: 'South America',
    image_urls: ['https://images.unsplash.com/photo-1587595431973-160d0d94add1?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80'],
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    name: 'Iceland',
    country: 'Iceland',
    notes: 'Land of fire and ice! Northern lights, geysers, and waterfalls.',
    visited: false,
    category: 'Nature',
    region: 'Europe',
    image_urls: ['https://images.unsplash.com/photo-1539650116574-75c0c6d73c6e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80'],
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    notes: 'Table Mountain, beautiful coastlines, and rich cultural heritage.',
    visited: true,
    category: 'Nature',
    region: 'Africa',
    image_urls: ['https://images.unsplash.com/photo-1580060839134-75a5edca2e99?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80'],
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    name: 'Amsterdam',
    country: 'Netherlands',
    notes: 'Canals, cycling culture, and world-class museums.',
    visited: false,
    category: 'City',
    region: 'Europe',
    image_urls: ['https://images.unsplash.com/photo-1534351590666-13e3e96b5017?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80'],
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
];
